...
public class LoginService {
    ...
    public UserBean login(String name){
        UserBean byName = loginMapper.findByName(name);
        UserBean byEmail = loginMapper.findByEmail(name);
        UserBean byPhone = loginMapper.findByPhone(name);
        if(byName != null){
            return byName;
    ...
    public Integer findUserCount(){
        return loginMapper.findUserCount();
    }
